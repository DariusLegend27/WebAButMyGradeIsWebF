#pragma checksum "C:\TheRealSEP\WebAButMyGradeIsWebF\WebAAssign\WebAAssign\Views\Product\ProductList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6e7836f325ed3e444a8f1099d34ec1ad2490170b"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6e7836f325ed3e444a8f1099d34ec1ad2490170b", @"/Views/Product/ProductList.cshtml")]
    ...
    <script>
        ...
        $.ajax({
            ...
            for (let index = 0; index < data.length; index++) {
                ...
                $cellElement = $('<td>' + prodImgUrl + '</td>');
                $row");
                WriteLiteral(@"Element.append($cellElement);
                ...
                var brandButton = """";
                console.log(brandButton);
                $cellElement = $('<td><button type=""button""><a href=""/Brand/UpdateBrand/' + data[index].prodId + '"">Update</a></button></td>')
                $ro");
                WriteLiteral(@"wElement.append($cellElement);
